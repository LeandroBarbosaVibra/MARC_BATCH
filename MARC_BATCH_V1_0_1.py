...
class MarcMentatGUI:
    ...
    def create_widgets(self):
        ...
        self.title_content.grid(row=0, column=0, sticky=(tk.W, tk.E), padx=5, pady=5)
        self.title_content.columnconfigure(0, weight=1)
        
        # Guideline button on the right
        self.guideline_btn = tk.Button(self.title_content, text="Guideline", command=open_guideline_pdf,
        ...
        self.guideline_btn.grid(row=0, column=1, rowspan=3, padx=5, pady=5, sticky=tk.E)
        
        # Centered title frame
        title_center = tk.Frame(self.title_content, bg=TITLE_BG_WINDOWS)
        title_center.grid(row=0, column=0, rowspan=3, sticky=(tk.W, tk.E))
